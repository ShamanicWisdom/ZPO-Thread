...
public class SingleWordThreads extends Thread 
{
    ...
    List<String> wordContainerList = new ArrayList<String>();
...
/****************************************************************************************************************************/
    ...
    public SingleWordThreads(String name, String location, TextArea threadArea) 
    {
        threadName = name;
       ...
       // int length = array.length;
        ...
        try 
        {
            for(int i = 0; i < wordContainerList.size(); i++)
            {
                ...
                out.print(wordContainerList.get(i) + " ");
                thread.sleep(10);
                out.flush();
            }
        }
...
/****************************************************************************************************************************/
    ...
    public synchronized void start() 
    {
        ...
        {         
            ...
            {
                reader = containerList.get(i);
                array = reader.split(" ");
                for ( String singleWord : array) 
                {
                    wordContainerList.add(singleWord);
                }
            }
